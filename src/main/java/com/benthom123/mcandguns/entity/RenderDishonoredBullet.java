...
@OnlyIn(Dist.CLIENT)
public class RenderDishonoredBullet<T extends EntityDishonoredBullet> extends EntityRenderer<T> {

	public static final ResourceLocation dbullet = new ResourceLocation("mcandguns:textures/entity/dishonoredbullet.png");
	
	
	public RenderDishonoredBullet(EntityRendererManager renderManager) {
		super(renderManager);
	}
...
//		GlStateManager.rotatef(MathHelper.lerp(partialTicks, entity.prevRotationYaw, entity.rotationYaw) - 90.0F, 0.0F,
//				1.0F, 0.0F);
//		GlStateManager.rotatef(MathHelper.lerp(partialTicks, entity.prevRotationPitch, entity.rotationPitch), 0.0F,
//				0.0F, 1.0F);
...
//	}
	...
	public ResourceLocation getEntityTexture(EntityDishonoredBullet entity) {
		return dbullet;
	}
